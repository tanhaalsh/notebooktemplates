/* @ds-bundle: {"format":3,"namespace":"CoreWeaveDesignSystem_a63cc0","components":[{"name":"Badge","sourcePath":"components/core/Badge.jsx"},{"name":"Button","sourcePath":"components/core/Button.jsx"},{"name":"Tag","sourcePath":"components/core/Tag.jsx"},{"name":"Card","sourcePath":"components/layout/Card.jsx"},{"name":"StatBlock","sourcePath":"components/layout/StatBlock.jsx"}],"sourceHashes":{"components/core/Badge.jsx":"3f1542b7b1ea","components/core/Button.jsx":"1ffec40abff0","components/core/Tag.jsx":"3589aa89795d","components/layout/Card.jsx":"86b730683cbb","components/layout/StatBlock.jsx":"bf8bdbb9a6a8","decks/ai-advanced-accounting/deck-stage.js":"5a5fcdcddfd9"},"inlinedExternals":[],"unexposedExports":[]} */

(() => {

const __ds_ns = (window.CoreWeaveDesignSystem_a63cc0 = window.CoreWeaveDesignSystem_a63cc0 || {});
...
/**
 * CoreWeave Badge — compact status / metadata label.
 * `tone` sets the color family; `solid` switches from a soft
 * tint to a filled treatment.
 */
function Badge({
  children,
  tone = "brand",
...
function _extends() { return _extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends.apply(null, arguments); }
/**
 * CoreWeave Button — emphasis-based action control.
 * Deck system: filled blocks for hierarchy (primary / secondary
 * / tertiary / support); outlined blocks for optional actions.
 * `variant` sets emphasis; `appearance="outline"` switches a
 * variant to its outlined form (primary + support are defined).
 */
function Button({
  children,
  variant = "primary",
  ...
  const outline = {
    primary: {
      background: "transparent",
      color: "var(--cw-blue-700)",
      border: "1px solid var(--cw-blue-500)",
      hover: "var(--cw-blue-50)"
    },
    secondary: {
      background: "transparent",
      color: "var(--cw-blue-700)",
      border: "1px solid var(--cw-blue-300)",
      hover: "var(--cw-blue-50)"
    },
    tertiary: {
      background: "transparent",
    ...
    support: {
      ...
      hover: "var(--cw-gray-100)"
    }
  };
  const set = appearance === "outline" ? outline : filled;
  const v = set[variant] || set.primary;
  const base = {
...
function _extends() { return _extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends.apply(null, arguments); }
/**
 * CoreWeave Tag — pill chip for categories, filters, and capability labels
 * (e.g. "GPU Compute", "Kubernetes"). Optionally selectable / removable.
 */
function Tag({
  children,
  selected = false,
  ...
  const base = {
    ...
    borderRadius: "var(--radius-pill)",
    border: "1px solid",
    borderColor: selected ? "var(--cw-blue-500)" : "var(--color-border)",
    background: selected ? "var(--cw-blue-50)" : "var(--cw-white)",
    color: selected ? "var(--cw-blue-700)" : "var(--text-secondary)",
  ...
  return /*#__PURE__*/React.createElement("span", _extends({
    style: base,
    onClick: onClick
  }, rest), iconLeft, children, onRemove && /*#__PURE__*/React.createElement("span", {
    onClick: e => {
      e.stopPropagation();
      onRemove(e);
    },
...
function _extends() { return _extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends.apply(null, arguments); }
/**
 * CoreWeave Card — surface container for grouped content & features.
 * Defaults to a bordered flat surface; `elevated` adds restrained shadow,
 * `tone="brand"` / `tone="inverse"` produce filled brand/dark panels.
 */
function Card({
  children,
  eyebrow,
  ...
  const muted = tone === "brand" || tone === "inverse" ? "rgba(255,255,255,0.6)" : "var(--text-muted)";
  const base = {
...
function _extends() { return _extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends.apply(null, arguments); }
/**
 * CoreWeave StatBlock — the deck's big-number treatment.
 * A large display figure with a caption above or below. Use for headline
 * metrics (capacity, scale, growth).
 */
function StatBlock({
  value,
  label,
  ...
  const color = tone === "inverse" ? "#fff" : "var(--text-primary)";
  const accent = tone === "inverse" ? "var(--cw-blue-300)" : "var(--cw-blue-700)";
  const muted = tone === "inverse" ? "rgba(255,255,255,0.6)" : "var(--text-muted)";
  return /*#__PURE__*/React.createElement("div", _extends({
    style: {
      fontFamily: "var(--font-brand)",
      textAlign: align,
...
// decks/ai-advanced-accounting/deck-stage.js
try { (() => {
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "decks/ai-advanced-accounting/deck-stage.js", error: String((e && e.message) || e) }); }
